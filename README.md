 ...
 * `instance_disk_capacities` ([]int) - Array of disk capacities (in GB) corresponding to disk indexes (ie. [25,100] provisions disk 0 with 25 GB and disk 1 with 100 GB). Default: one disk with 25 GB
